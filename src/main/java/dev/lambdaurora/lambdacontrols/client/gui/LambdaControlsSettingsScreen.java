...
public class LambdaControlsSettingsScreen extends SpruceScreen {
    ...
    private final SpruceOption axeButtonThresholdOption;
    ...
    public LambdaControlsSettingsScreen(Screen parent, boolean hideControls) {
        ...
        // Controller options
        this.axeButtonThresholdOption = new SpruceDoubleOption("lambdacontrols.menu.axe_button_threshold", 0.05, 1.0, .05f,
                this.config::getAxeButtonThreshold,
                newValue -> {
                    synchronized (this.config) {
                        this.config.setAxeButtonThreshold(newValue);
                    }
                }, option -> {
        ...
        }, new TranslatableText("lambdacontrols.tooltip.axe_button_threshold"));
    ...
    public AbstractSpruceWidget buildControllerTab(int width, int height) {
        ...
        list.addSingleOptionEntry(this.axeButtonThresholdOption);
